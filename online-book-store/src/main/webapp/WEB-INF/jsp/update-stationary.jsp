...
<body class="min-h-screen bg-cover bg-center" style="background-image: url('https://cdn.pixabay.com/photo/2017/08/07/01/40/books-2598503_1280.jpg');">
  <div class="min-h-screen flex items-center justify-center bg-black bg-opacity-50 p-4">
    <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
      <h1 class="text-3xl font-semibold text-center mb-6">Update Stationary</h1>

      <form:form modelAttribute="stationary"
                 method="post"
                 action="${pageContext.request.contextPath}/stationary/update"
        ...
        <div>
          ...
          <input type="file" name="image" id="image" accept="image/*"
                 class="w-full bg-white text-gray-900 rounded-lg px-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500"/>
        </div>
